...
const users = [
  ...
  },
  {
    ...
    imgSrc: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQceZG8o4B9jRchPdWxfvDfo9AmLokYyT9EQ&s",
  },
  {
    id: 3,
    name: "Mike Tyson",
    description: "knockout king",
    imgSrc: "https://upload.wikimedia.org/wikipedia/en/thumb/d/d6/Superman_Man_of_Steel.jpg/250px-Superman_Man_of_Steel.jpg",
  },
];
      ...
      >
        ...
        <div className="flex w-full justify-between h-full relative z-10">
          <div className="w-[70%]">
            ...
            <p className="text-xs leading-none mb-2" style={{ color: textColor }}>
              {user.description}
            </p>
          </div>
